...
public class MinimumNumberOfTapsToOpenToWaterAGarden_1326 {
    ...
    public void run() {
        int n = 5;
        int[] ranges = new int[]{3, 1, 1, 2, 0, 0};
//        int[] ranges = new int[]{0, 0, 0, 0, 0, 0};
        System.out.println(minTapsFormal(n, ranges));
    }
     ...
     */
    public int minTapsFormal(int n, int[] ranges) {
        int[] pre = new int[n + 1];
